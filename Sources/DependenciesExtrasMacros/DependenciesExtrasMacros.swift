...
@attached(peer, names: prefixed(_$)) public macro DependencyProtocolClient() =
  #externalMacro(
...
public macro DependencyConformance() =
  #externalMacro(
    module: "DependenciesExtrasMacrosPlugin",
...
public macro DependencyImplementClient<T>(of: T.Type) =
  #externalMacro(
    module: "DependenciesExtrasMacrosPlugin",
